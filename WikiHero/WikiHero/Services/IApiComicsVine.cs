...
namespace WikiHero.Services
{
    public interface IApiComicsVine
    {
        ...
        [Get("/api/movies?api_key={api_key}&format=json&offset={offset}&filter=date_last_updated : 2018-09-02 17:47:38|2020-03-10 11:00:00&sort=date_last_updated : desc")]
        Task<ResultMovies> GetAllMovies(string api_key, int offset);
